        ...
        <div className="his-shell bg-[#f8fafc]">
            ...
            <header className="relative px-6 py-4 md:px-12 md:py-8 flex flex-col md:flex-row justify-between items-center md:items-start z-10 gap-6 md:gap-0 text-center md:text-left">
                <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6">
                    <img src={logo} alt="Action Care" className="w-14 h-14 md:w-20 md:h-20 object-contain drop-shadow-2xl" />
                    <div>
                        <h1 className="text-xl md:text-2xl font-black text-slate-800 font-outfit uppercase tracking-tighter leading-none">Sri Balaji Action Medical Institute</h1>
                        <p className="text-[10px] font-bold text-brand-500 mt-2 uppercase tracking-[0.2em] md:tracking-[0.4em] opacity-80">Hospital Registry Console</p>
                    </div>
                </div>
                    ...
                    <div className="w-full grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12 items-center">
                        ...
                        <div className="lg:col-span-2 space-y-6 md:space-y-10 reveal-up text-center lg:text-left" style={{ animationDelay: '0.1s' }}>
                            <div className="space-y-4">
                                <h2 className="text-3xl md:text-5xl font-bold text-slate-900 leading-[1.1] font-outfit tracking-tighter">
                                    Secure <br className="hidden md:block" /> <span className="text-brand-500">Visitation</span> <br className="hidden md:block" /> Protocol.
                                </h2>
                            ...
                            <div className="flex flex-col gap-6">
                                <div className="flex items-center gap-4 group">
                                    <div className="p-3 bg-white border border-slate-100 rounded-xl shadow-sm group-hover:bg-brand-50 transition-colors">
                        ...
                        <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-8 reveal-up" style={{ animationDelay: '0.2s' }}>
                            ...
                            <div
                                ...
                                className="his-premium-card p-6 md:p-10 group cursor-pointer border-brand-100/50 bg-white/80 backdrop-blur-xl relative overflow-hidden"
                            >
                                <div className="absolute top-0 right-0 p-8 text-slate-50 opacity-10 scale-150 rotate-12 transition-transform duration-700 group-hover:scale-[2] group-hover:text-brand-500 group-hover:opacity-20">
                                    <UserPlus size={160} />
                                </div>

                                <div className="relative z-10 h-full flex flex-col items-center md:items-start text-center md:text-left">
                                    <div className="w-14 h-14 md:w-16 md:h-16 bg-brand-500 text-white rounded-2xl flex items-center justify-center mb-6 md:mb-10 shadow-lg shadow-brand-500/30 group-hover:scale-110 transition-transform">
                                    ...
                                    <div className="mt-auto w-full">
                                        <button className="his-btn-impact w-full bg-brand-900 py-3 md:py-4 text-xs md:text-sm hover:bg-black uppercase tracking-widest">
                                            Open Session
                                        </button>
                                    </div>
                                </div>
                            ...
                            >
                                ...
                                <div className="relative z-10 h-full flex flex-col items-center md:items-start text-center md:text-left">
                                    ...
                                    <div className="mt-auto w-full">
                                        <button className="his-btn-impact w-full bg-white text-slate-900 py-3 md:py-4 text-xs md:text-sm hover:bg-brand-500 hover:text-white border-none uppercase tracking-widest">
                                            Staff Login
                                        </button>
                                    </div>
                                </div>
            ...
            <footer className="relative bg-white border-t border-slate-100 z-10 py-5 px-6 md:px-12 flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left overflow-hidden">
                <div className="flex flex-col sm:flex-row gap-4 md:gap-10 items-center">
                    <div className="flex items-center gap-3">
                        <Monitor className="text-brand-500" size={14} md:size={16} />
                    ...
                    <div className="flex items-center gap-3">
                        <Network className="text-brand-500" size={14} md:size={16} />
