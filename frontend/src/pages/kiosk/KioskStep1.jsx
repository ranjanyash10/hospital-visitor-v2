            ...
            <header className="sticky top-0 px-6 py-4 md:px-12 md:py-8 flex flex-col md:flex-row justify-between items-center z-50 border-b border-slate-100 bg-white/50 backdrop-blur-md gap-4">
                <div className="flex items-center gap-5">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] font-black text-brand-500 mt-2 uppercase tracking-[0.2em] md:tracking-[0.3em] opacity-80">Registry Clearance Phase 01/03</p>
                    </div>
                </div>
                ...
                <div className="hidden lg:flex w-96 bg-[#0f172a] text-white p-12 flex-col justify-center sticky top-0 h-full">
                    ...
                    <div className="space-y-8">
                        <div className="flex gap-5">
                            <div className="w-6 h-6 bg-brand-500 rounded-lg flex items-center justify-center text-[10px] font-black shrink-0">01</div>
                        ...
                        <div className="flex-1 overflow-y-auto px-6 md:px-8 lg:px-12 py-4">
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="space-y-4">
                                    <label className="text-[10px] font-bold text-brand-500 uppercase tracking-[0.2em] ml-2">Registered Mobile Number</label>
                                    <div className="flex gap-4">
                                        <div className="relative flex-1">
                                            ...
                                            />
                                            <Smartphone className={`absolute left-5 top-1/2 -translate-y-1/2 ${patients.length > 0 ? 'text-emerald-500' : 'text-brand-400/50'}`} size={24} />
                                        </div>
                                        {patients.length === 0 ? (
                                            <button
                                                onClick={handleMobileSearch}
                                                disabled={searching || mobile.length < 10}
                                                className="his-btn-impact px-8 py-4 shadow-xl shadow-brand-500/20 disabled:opacity-50"
                                            >
                                ...
                                {patients.length > 0 && (
                                    <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                        ...
                                        {patients.length === 1 ? (
                                            /* Auto-selected Card */
                                            <div className="p-6 bg-brand-50/50 border-2 border-brand-200 rounded-3xl flex items-center justify-between">
                                                <div className="flex items-center gap-6">
                                                    <div className="w-14 h-14 bg-brand-100 text-brand-500 rounded-2xl flex items-center justify-center shadow-inner">
                                                        <User size={28} />
                                                    </div>
                                                    <div>
                                                ...
                                                {patients.map(p => (
                                                    ...
                                                    >
                                                        ...
                                                        {selectedPatient?.admission_id === p.admission_id && (
                                                            <div className="w-6 h-6 bg-brand-500 text-white rounded-full flex items-center justify-center">
                        ...
                        <div className="p-6 lg:p-8 pt-4 border-t border-slate-50 bg-slate-50/30">
                            <div className="flex gap-4">
                                ...
                                <button
                                    ...
                                    className={`his-btn-impact flex-[2] py-4 shadow-2xl transition-all duration-500 ${selectedPatient ? 'shadow-brand-500/30' : 'opacity-30 grayscale'}`}
                                >
