                ...
                <div className="max-w-lg mx-auto flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-[8px] font-bold text-blue-600 uppercase tracking-[0.2em]">Action Care Hospital</p>
                        </div>
                    </div>
                            ...
                            <div className="space-y-4">
                                <div className="relative">
                                    <input
                                        type="tel"
                                        maxLength="10"
                                        className="w-full h-14 pl-12 pr-4 bg-slate-50 border-2 border-slate-100 rounded-2xl text-lg font-bold tracking-[0.15em] text-slate-800 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none transition-all"
                                        placeholder="10-digit number"
                                        value={mobile}
                                        onChange={(e) => setMobile(e.target.value.replace(/\D/g, ''))}
                                        autoFocus
                                    />
                                    <Smartphone className="absolute left-4 top-1/2 -translate-y-1/2 text-blue-400/50" size={20} />
                                </div>
                                <button
                                    onClick={handleMobileSearch}
                                    disabled={loading || mobile.length < 10}
                                    className="w-full h-14 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl font-bold text-sm uppercase tracking-wider flex items-center justify-center gap-3 disabled:opacity-40 transition-all shadow-lg shadow-blue-600/20"
                                >
                    ...
                    <div className="space-y-4 animate-in fade-in">
                        <div className="bg-white rounded-3xl shadow-lg shadow-slate-200/50 p-6">
                                ...
                                {patients.map(p => (
                                    ...
                                    >
                                        <div className="flex items-center gap-4">
                                            <div className={`w-11 h-11 rounded-xl flex items-center justify-center transition-colors ${selectedPatient?.admission_id === p.admission_id ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-400'
                                                }`}>
                                                <User size={20} />
                                            </div>
                                            <div>
                            ...
                            <button
                                ...
                                className="w-full h-14 mt-5 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl font-bold text-sm uppercase tracking-wider flex items-center justify-center gap-3 disabled:opacity-40 transition-all shadow-lg shadow-blue-600/20"
                            >
                            ...
                            <div className="flex justify-center gap-3 mb-6">
                                {otp.map((digit, i) => (
                                    <input
                                        ...
                                        className="w-14 h-16 text-center text-2xl font-bold bg-slate-50 border-2 border-slate-100 rounded-2xl focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none transition-all"
                                        autoFocus={i === 0}
                                    />
                                ))}
                            </div>
                    ...
                    <div className="space-y-4 animate-in fade-in">
                        <div className="bg-white rounded-3xl shadow-lg shadow-slate-200/50 p-6">
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="w-full h-14 bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl font-bold text-sm uppercase tracking-wider flex items-center justify-center gap-3 disabled:opacity-40 transition-all shadow-lg shadow-indigo-600/20"
                            >
