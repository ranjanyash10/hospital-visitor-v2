        ...
        <div className="his-shell bg-[#f8fafc] items-center justify-center p-6">
            ...
            <div className="w-full max-w-md animate-fade relative z-10">
                <div className="text-center mb-10 flex flex-col items-center">
                    ...
                    <p className="text-[10px] font-bold text-blue-600 tracking-widest mt-2 uppercase opacity-70">Institutional Domain Authorization</p>
                </div>
                ...
                <div className="bg-white border border-slate-200 rounded-3xl shadow-xl overflow-hidden ring-1 ring-slate-200/50">
                    <div className="bg-[#1e293b] px-8 py-4 flex justify-between items-center text-white">
                        <span className="text-[10px] font-bold uppercase tracking-wider flex items-center gap-3">
                            <ShieldCheck size={16} className="text-blue-400" /> Security Terminal G-01
                        </span>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                            <div className="space-y-1.5 md:space-y-2">
                                ...
                                <div className="relative group">
                                    <input
                                        type="text"
                                        required
                                        className="w-full px-4 py-3 md:px-5 md:py-4 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:border-blue-600 outline-none transition-all text-sm md:text-base font-semibold placeholder:text-slate-300"
                            ...
                            <div className="pt-2 md:pt-4">
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="w-full py-3.5 md:py-4 bg-blue-600 text-white rounded-xl font-bold text-[11px] md:text-sm uppercase tracking-wider hover:bg-blue-700 shadow-lg shadow-blue-600/20 active:scale-95 transition-all flex items-center justify-center gap-3"
                                >
