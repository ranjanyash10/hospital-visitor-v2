            ...
            <header className="sticky top-0 px-6 py-4 md:px-12 md:py-8 flex flex-col md:flex-row justify-between items-center z-50 border-b border-slate-100 bg-white/50 backdrop-blur-md gap-4">
                <div className="flex items-center gap-5">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] font-black text-blue-600 mt-2 uppercase tracking-[0.2em] md:tracking-[0.3em] opacity-80">Registry Clearance Phase 02/03</p>
                    </div>
                </div>
                ...
                <div className="hidden lg:flex w-96 bg-[#0f172a] text-white p-12 flex-col justify-center sticky top-0 h-full">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="flex gap-5">
                            <div className="w-6 h-6 bg-blue-600 rounded-lg flex items-center justify-center text-[10px] font-black shrink-0">02</div>
                    ...
                    <div className="w-full max-w-4xl bg-white his-premium-card flex flex-col max-h-[95vh] shadow-[0_40px_80px_rgba(0,0,0,0.06)] overflow-hidden">
                        <div className="flex-1 overflow-y-auto px-6 md:px-12 lg:px-20 py-8">
                            <div className="text-center mb-8">
                                <div className="w-14 h-14 bg-blue-600/10 text-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-sm border border-blue-100">
                                    <ShieldCheck size={28} />
                                </div>
                                ...
                                <div className="mt-6 inline-flex items-center gap-3 px-6 py-2 bg-slate-50 rounded-2xl border border-slate-100">
                                    ...
                                    <span className="text-blue-600 font-bold font-mono text-base md:text-lg tracking-[0.2em]">•••• {state?.relativeMobile?.slice(-4)}</span>
                                </div>
                            </div>
                                ...
                                {otp.map((digit, index) => (
                                    <input
                                        ...
                                        className={`w-full aspect-square text-center text-2xl md:text-4xl font-black font-outfit rounded-xl md:rounded-[1.5rem] border-2 transition-all duration-300 outline-none
                                            ${digit
                                                ? 'bg-blue-50 border-blue-600 text-blue-600 shadow-xl shadow-blue-600/10'
                                                : 'bg-slate-50 border-slate-100 text-slate-800 focus:bg-white focus:border-blue-500'
                                            }`}
                                        value={digit}
                            ...
                            <div className="flex justify-between items-center px-4 mb-4">
                                <button
                                    ...
                                    className="text-[10px] font-black text-slate-400 hover:text-blue-600 uppercase tracking-[0.3em] transition-all flex items-center gap-2 disabled:opacity-30 group"
                                >
                        ...
                        <div className="p-6 lg:p-10 border-t border-slate-50 bg-slate-50/30">
                            <div className="flex flex-col gap-6">
                                ...
                                <div className="flex justify-center">
                                    <Link to="/kiosk/enter-details" className="text-slate-400 text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] md:tracking-[0.4em] flex items-center gap-3 hover:text-blue-600 hover:-translate-x-2 transition-all duration-500">
